        ...
        def dfs(switch_idx):
            ...
            for neighbor_idx in range(graph.switch_count):
                if (neighbor_idx != switch_idx and 
                    graph.switches[switch_idx].links[neighbor_idx].cost > 0 and 
